...
export const EmployeeDashboard: React.FC = () => {
  ...
  // Shift progress calculation (assuming 8 hour standard shift = 28800s)
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-5 relative z-10">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-indigo-100 font-medium">
              {currentUser.designation} • {currentUser.location}
            </p>
          </div>
        </div>
      ...
      {/* 2-Column Grid: Punch Clock & Leave Balances */}
          ...
          <div>
            ...
            <div className="my-6 text-center">
              ...
              <p className="text-xs text-slate-400 mt-1 font-medium">
                Standard shift: 09:00 AM - 05:00 PM (8.0 hrs)
              </p>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200/80 dark:border-slate-700/80 p-6 shadow-soft">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-5">
              <div className="p-4 rounded-2xl bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-800/60">
                <div className="text-xs font-bold text-indigo-700 dark:text-indigo-300">Casual Leave</div>
              ...
              <div className="p-4 rounded-2xl bg-amber-50/70 dark:bg-amber-950/40 border border-amber-100 dark:border-amber-800/60">
                <div className="text-xs font-bold text-amber-700 dark:text-amber-300">Annual Leave</div>
                <div className="text-2xl font-black text-slate-900 dark:text-white mt-1">
      ...
      {/* Bottom Grid: Payslips & Upcoming Company Holidays */}
