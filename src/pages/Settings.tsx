            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500/20"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  type="number"
                  step="0.5"
                  value={shiftRules.halfDayThresholdHours}
                  onChange={(e) => setShiftRules({ ...shiftRules, halfDayThresholdHours: Number(e.target.value) })}
                  className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500/20"
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center gap-3 p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-700/40 border border-slate-100 dark:border-slate-700 cursor-pointer">
                <input type="checkbox" defaultChecked className="w-4 h-4 text-brand-600 rounded" />
                <div>
                  <div className="text-xs font-bold text-slate-900 dark:text-white">Late Check-in Flags</div>
                  <div className="text-[11px] text-slate-500">Notify department lead if employee is late by 30+ minutes</div>
                </div>
              </label>
            </div>
          </div>
