  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Left 2 Cols: Actionable Approvals & Attendance Snapshot */}
                  ...
                  <div key={req.id} className="py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 self-end sm:self-center">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 dark:bg-slate-700 hover:bg-rose-50 hover:text-rose-600 dark:hover:bg-rose-950/40 text-slate-600 dark:text-slate-300 text-xs font-bold rounded-xl transition"
                      >
        ...
        {/* Right Col: Live Activity Feed & Quick Actions */}
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200/80 dark:border-slate-700/80 p-6 shadow-soft">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-[10px] text-slate-500">Onboard employee</div>
              </button>
      ...
      <Modal
        ...
        subtitle="Fill in employment details to create a Dayflow profile"
        maxWidth="2xl"
      >
